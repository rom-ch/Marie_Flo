...
const addMoreFields = function (i, genre) {
	...
	<div class="second-part-${genre.toLowerCase()}">
						<div class="second-part-inwrapper">
							...
							<div class="name">
								<div class="form__group">
									<input
										...
										required
									/>
									<label for="${genre[0].toUpperCase()}${i}-lname" class="form__label">Last Name</label>
								</div>
								<div class="form__group">
									<input
										type="text"
										...
										required
									/>
									<label for="${genre[0].toUpperCase()}${i}-fname" class="form__label">First Name</label>
								</div>
							</div>
							<div class="attend">
								<div class="checkbox-container">
									...
									<label for="${genre[0].toUpperCase()}-attend-brunch${i}" class="brunch"
										>Will be present for the Sunday brunch</label
									>
								</div>
							...
							<label for="${genre[0].toUpperCase()}${i}-food">Allergies & Food restrictions</label>
						</div>
						<div class="add-food form__group">
							<input
								...
								data-food-input
							/>
							<button class="btn-form btn-add">Add</button>
						</div>
					</div>
